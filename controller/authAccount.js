...
exports.updateuser = (req, res) => {
    ...
    if (firstName === "" || lastName === "") {
        res.render("updateform", {message: "First Name and Last Name should not be empty!", 
            ...
            (err, result) => {
                if (err){
                    ...
                    db.query(
                        ...
                        (err,results) => {
                            // console.log(results)
                            res.render("listAccounts", {title:"List of Users", accounts : results, message: "Successfully Updated the account"});
                        }
                    )
